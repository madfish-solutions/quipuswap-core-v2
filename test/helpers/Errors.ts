export enum DexCore {
  ...
  ERR_BUCKET_BAN_BAKER_ENTRYPOINT_404 = "122",
  ERR_BUCKET_VOTE_ENTRYPOINT_404 = "123",
  ERR_BUCKET_IS_BANNED_BAKER_VIEW_404 = "124",
  ERR_FLASH_SWAPS_PROXY_DEFAULT_ENTRYPOINT_404 = "125",
  ERR_BUCKET_GET_TEZ_BALANCE_VIEW_404 = "126",
  ERR_FLASH_SWAP_CALLBACK_404 = "127",
  ERR_WRONG_FLASH_SWAP_RETURNS = "128",
  ERR_CAN_NOT_REFER_YOURSELF = "129",
  ERR_BUCKET_WITHDRAW_REWARDS_ENTRYPOINT_404 = "130",
  ERR_INSUFFICIENT_INTERFACE_FEE_BALANCE = "131",
  ERR_BUCKET_GET_USER_CANDIDATE_VIEW_404 = "132",
  ERR_LAUNCH_CALLBACK_404 = "133",
  ERR_AUCTION_RECEIVE_FEE_ENTRYPOINT_404 = "134",
  ERR_REENTRANCY = "135",
  ERR_CLOSE_ENTRYPOINT_404 = "136",
  ERR_NOT_ENTERED = "137",
  ERR_TOO_FEW_SWAPS = "138",
  ERR_CAN_NOT_PERFORM_VOTING = "139",
  ERR_TEZ_AMOUNT_MISMATCH = "140",
...
export enum Bucket {
  ...
  ERR_DEX_CORE_GET_TOTAL_SUPPLY_VIEW_404 = "201",
  ERR_DEX_CORE_GET_VOTING_PERIOD_VIEW_404 = "202",
  ERR_DEX_CORE_GET_COLLECTING_PERIOD_VIEW_404 = "203",
  ERR_DEX_CORE_GET_CYCLE_DURATION_VIEW_404 = "204",
}
