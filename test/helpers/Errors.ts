export enum DexCore {
  ...
  ERR_HIGH_OUT = "140",
  ERR_INSUFFICIENT_INTERFACE_FEE_BALANCE = "141",
  ERR_TEZ_STORE_GET_USER_CANDIDATE_VIEW_404 = "142",
  ERR_LAUNCH_CALLBACK_404 = "143",
  ERR_AUCTION_RECEIVE_FEE_ENTRYPOINT_404 = "144",
  ERR_REENTRANCY = "145",
