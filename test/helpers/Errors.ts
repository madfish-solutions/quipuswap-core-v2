export enum DexCore {
  ...
  ERR_FA12_BALANCE_CALLBACK_1_404 = "130",
  ERR_FA2_BALANCE_CALLBACK_1_404 = "131",
  ERR_FA12_BALANCE_CALLBACK_2_404 = "132",
  ERR_FA2_BALANCE_CALLBACK_2_404 = "133",
  ERR_WRONG_FLASH_SWAP_RETURNS = "134",
  ERR_CAN_NOT_REFER_YOURSELF = "135",
  ERR_TEZ_STORE_WITHDRAW_REWARDS_ENTRYPOINT_404 = "136",
  ERR_HIGH_OUT = "137",
  ERR_INSUFFICIENT_INTERFACE_FEE_BALANCE = "138",
  ERR_TEZ_STORE_GET_USER_CANDIDATE_VIEW_404 = "139",
  ERR_LAUNCH_CALLBACK_404 = "140",
  ERR_AUCTION_RECEIVE_FEE_ENTRYPOINT_404 = "141",
  ERR_REENTRANCY = "142",
  ERR_CLOSE_ENTRYPOINT_404 = "143",
  ERR_NOT_ENTERED = "144",
}
