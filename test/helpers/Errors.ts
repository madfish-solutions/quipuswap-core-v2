export enum DexCore {
  ...
  ERR_TEZ_STORE_WITHDRAW_REWARDS_ENTRYPOINT_404 = "135",
  ERR_HIGH_OUT = "136",
  ERR_INSUFFICIENT_INTERFACE_FEE_BALANCE = "137",
  ERR_TEZ_STORE_GET_USER_CANDIDATE_VIEW_404 = "138",
  ERR_LAUNCH_CALLBACK_404 = "139",
  ERR_AUCTION_RECEIVE_FEE_ENTRYPOINT_404 = "140",
}
